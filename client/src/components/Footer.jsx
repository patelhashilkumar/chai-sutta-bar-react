        ...
        <>
            ...
            <section className="bg-white py-16 text-center">
                <div className="container mx-auto px-6">
                    <p className="text-gray-500 text-lg md:text-xl font-medium mb-2">Want To Franchise With Us?</p>
                    <h2 className="text-4xl md:text-5xl font-bold text-black mb-8">Request A Franchise Consultation</h2>
                    <Link to="/franchise">
                        <button className="bg-[#4a2c2a] text-white px-8 py-3 rounded-full font-bold text-lg hover:bg-[#3a1f1e] transition duration-300">
                            Apply Now
                        </button>
                    </Link>
                </div>
